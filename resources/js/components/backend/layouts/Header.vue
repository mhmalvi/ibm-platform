    ...
    <!-- Page Header Start-->
      <div class="page-main-header">
        <div class="main-header-right row">
          <div class="main-header-left d-lg-none">admin@ibm.com
            <div class="logo-wrapper"><a href="#"><img :src="image_url+'/uploads/user/profile.png'" alt=""></a></div>
          </div>
          ...
          <div class="nav-right col p-0">
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle" :src="image_url+'/uploads/user/'+profile_pic" alt="header-user">
                  <div class="dotted-animation"><span class="animate-circle"></span><span class="main-circle"></span></div>
                </div>
                <ul class="profile-dropdown onhover-show-div p-20">
                  <li><a href="#"><i data-feather="user"></i>{{user.user.name}}</a></li>
                  <!-- <li><a href="#"><i data-feather="user"></i>Edit Profile</a></li> -->
                  <!-- <li><a href="#"><i data-feather="mail"></i>Inbox</a></li>
                  <li><a href="#"><i data-feather="lock"></i>Lock Screen</a></li>
                  <li><a href="#"><i data-feather="settings"></i>Settings</a></li> -->
                  <li><router-link to="#" @click.native="signOut"><i data-feather="log-out"></i>Logout</router-link></li>
                </ul>
              </li>
            </ul>
          ...
          <script id="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">Search things</div>
            </div>
            </div>
          </script>
  ...
  mixins:[path],
    ...
    created(){
       if(this.user != null){
            ...
            this.profile_pic = this.user.user.photo == null?'profile.png':this.user.user.photo
