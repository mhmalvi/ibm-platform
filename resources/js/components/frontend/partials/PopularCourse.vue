<template>
    <!-- case-gallery start -->
    <!-- class="feature-course pt-md-95 pb-md-80 pt-xs-95 pb-xs-80" -->
    <section
        class="feature-course pt-md-40 pb-md-60 pt-xs-20 pb-xs-20"
        v-if="courses.length > 0"
    >
        <div class="container pb-sm-5 pb-md-100">
            <div class="row">
                <div class="col-xl-12">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-12 text-center">
                    <div class="portfolio-menu mb-30">
                        ...
                        <button
                            class="gf_btn"
                            :class="{ active: category.id == is_active }"
                            v-for="(category, index) in categories"
                            :key="index"
                            :data-filter="'cat' + index"
                            @click="
                                getSelectedCourse(category.courses, category.id)
                            "
                        >
                            {{ category.name }}
                        </button>
                            ...
                            >
                                <span
                                    ><img
                                        ...
                                        :src="
                                            image_url +
                                            '/frontend/assets/img/icon/catalog.svg'
                                        "
                                        alt="course-meta"
                                    />
