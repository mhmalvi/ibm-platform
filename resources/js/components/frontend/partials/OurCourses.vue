<template>
    ...
    <section class="what-looking-for pos-rel">
        <div
            class="what-look-bg pt-80 pb-100 pt-md-50 pb-md-60 pt-xs-20 pb-xs-50"
        >
            <div class="container">
                                ...
                                <div class="card text-center pt-4">
                                    <div class="card-body">
                                        <img
                                            ...
                                            :src="
                                                image_url +
                                                '/frontend/assets/img/courses/business.jpg'
                                            "
                                            alt=""
                                        />
                                ...
                                <div class="card text-center p-4">
                                    <div class="card-body">
                                        <img
                                            ...
                                            :src="
                                                image_url +
                                                '/frontend/assets/img/courses/trade.svg'
                                            "
                                            alt=""
                                        />

                                        <h6 class="sub-title mb-10">
                                            <a href="/industry/trade">Trade</a>
                                        </h6>
                                    </div>
                                </div>
                            </a>
                                ...
                                <div class="card text-center p-4">
                                    <div class="card-body">
                                        <img
                                            ...
                                            :src="
                                                image_url +
                                                '/frontend/assets/img/courses/english.svg'
                                            "
                                            alt=""
                                        />
