    ...
    <section class="slider-area pb-xs-35">
        ...
        >
            ...
            <div class="carousel-inner">
                <div
                    class="carousel-item text-center active ibm-courosel-item"
                    :style="slider_one"
                >
                    <div
                    ...
                    >
                        ...
                        <div>
                            <router-link
                                to="/courses"
                                class="btn btn-lg fs-5 theme-bg text-white mt-4 wow fadeInUp2 animated"
                                data-wow-delay=".2s"
                ...
                <div
                    class="carousel-item text-center ibm-courosel-item"
                    :style="slider_two"
                >
                    <div
                        class="d-flex flex-column h-100 align-items-center justify-content-center"
                    >
                        ...
                        <p
                            class="text-white mt-3 mb-3 pt-2 pb-2 fw-bolder fs-5 wow fadeInUp2 animated"
                            data-wow-delay=".01s"
                        >
                        ...
                        <div>
                            <router-link
                                to="/courses/certificate-iii-in-carpentry"
                                class="btn fs-5 theme-bg text-white wow fadeInUp2 animated"
                                data-wow-delay=".2s"
                                >Learn More</router-link
                            >
                        </div>
                ...
                >
                    ...
                    >
                        ...
                        <p
                            ...
                            data-wow-delay=".01s"
                        >
                            Find your best English courses at IBM
                        </p>
                        <div>
                            <router-link
                                to="/courses/elicos-general-english"
                                class="btn fs-5 theme-bg text-white wow fadeInUp2 animated"
                                data-wow-delay=".2s"
                                >Learn More</router-link
                            >
