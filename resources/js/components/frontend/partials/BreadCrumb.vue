      ...
      <div class="row align-items-end">
        <div class="col-lg-12">
          <div class="page-title-wrapper mb-50">
            <h1 class="page-title mb-25 theme-color">{{ pageName }}</h1>
            <div class="breadcrumb-list">
              <ul class="breadcrumb">
                <li><a href="/">Home - </a></li>
                <li>
                  <a href="#" class="theme-color">{{ pageName }}</a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
    ...
    "$route.params.slug"(newSlug, oldSlug) {
      ...
      if (newSlug == "certificate-iii-in-carpentry") {
        ...
        if (
          ...
          return (this.pageName = finalResult.replace(
            /(?:^|\s)\S/g,
            function (a) {
  ...
  mounted() {
    ...
    this.background =
      "background-image: url(/public/frontend/assets/img/page-title-bg/01.jpg);";
  },
