        ...
        <div class="offset-sidebar">
            ...
            <div class="offset-widget mb-40">
                <div class="info-widget">
                    ...
                    <p class="mb-30">
                        ...
                        Registered Training Organisation that offers a vibrant,
                        unique learning experience for students.
                    </p>
                    <a class="theme_btn theme_btn_bg" href="/contact-us"
                        >Contact Us</a
                    >
                </div>
            </div>
            <div class="offset-widget mb-30 pr-10">
                <div class="info-widget info-widget2">
                    ...
                    <p>
                        <i class="fal fa-address-book"></i> 60 Belfast St
                        BROADMEADOWS VIC 3047
                    </p>
                    <p><i class="fal fa-phone"></i> +(03) 9478 3163</p>
                    <p>
                        <i class="fal fa-envelope-open"></i> info@ibm.vic.edu.au
                    </p>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        getCourses() {
            axios
                .get(this.base_url + "/api/get-course")
                .then((response) => {
