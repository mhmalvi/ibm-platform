    ...
    <div class="container">
      <div class="row border-bot border-top" style="padding: 20px 0">
        <div class="col-sm-3 wow fadeInUp2 animated">
          <div class="footer-log mb-20 text-center text-sm-left my-3 my-sm-0">
            <a href="/" class="logo">
              <img
        ...
        >
          ...
          <div>
            <a href="mailto:info@ibm.vic.edu.au"
              ><i class="fa fa-envelope"></i>&nbsp; info@ibm.vic.edu.au</a
            >
          </div>
        </div>
      </div>
      <div class="row mb-15 mt-50">
        ...
        >
          <div class="footer__widget mb-30">
            <h5 class="widget-title pb-20">Subscribe to our newsletter</h5>
            <div class="row justify-content-center">
              <div class="subscribe-wrapper mb-30">
                <p class="text-left">
                  Make a click and get updated with our latest news.
                </p>
        ...
        >
          <div class="footer__widget mb-25 pl-90 pl-md-0 pl-xs-0">
            ...
            <ul class="fot-list">
              ...
              <li>
                <router-link to="/why-choose-ibm">Why Choose IBM</router-link>
              </li>

              <li>
                <router-link to="/forms-policies">Forms & Policies</router-link>
              </li>
              <li>
                <router-link to="/how-to-apply">How To Apply</router-link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-12">
            <div class="copyright text-center">
              <h5>
                Copyright@ 2023
                <a style="color: #ff723a" href="#">IBM</a>. All Rights Reserved
                | Developed By
                <a
                  style="color: #6a30f7"
                  target="_blank"
