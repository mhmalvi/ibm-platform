<template>
    <div>
        <div class="container">
            <div class="row mt-5">
                <h3 class="text-center">Application/Enrolment Form</h3>
            </div>
                ...
                <div class="col-md-10 mx-auto">
                    ...
                    <div class="ms-3 mt-5 mb-2" v-if="step_number != 6">
                        <ul class="decimal-list">
                            ...
                            <li>
                                Attach supporting documents, including certified
                                copies of your passport and Academic Documents
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="row py-5 d-flex justify-content-center">
                            ...
                            >
                                <img
                                    ...
                                    :src="
                                        image_url +
                                        '/frontend/assets/img/success_submit.gif'
                                    "
                                    alt="Success"
                                    class="img-fluid"
                                />
