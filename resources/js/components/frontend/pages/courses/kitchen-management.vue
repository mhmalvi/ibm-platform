        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="my-3"></div>
                    <p class="p-justify">
                        This qualification reflects the role of chefs and cooks
                        who have a supervisory or team leading role in the
                        kitchen. They operate independently or with limited
                        guidance from others and use discretion to solve
                        non-routine problems. This qualification provides a
                        pathway to work in organisations such as restaurants,
                        hotels, clubs, pubs, cafes, and coffee shops, or to run
                        a small business in these sectors. The skills in this
                        qualification must be applied in accordance with
                    ...
                    <table class="table table-responsive">
                        <tbody>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    SIT40521 Certificate IV in Kitchen
                                    Management.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    and assessment is completed in commercial
                                    kitchen and 200 hours of Work-based Training
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps0">
                            <div class="card card-body">
                                ...
                                <p>
                                    Students must be a minimum age of 18 years
                                    or above at the time of course commencement.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="collapsible">
                        ...
                        >
                            ...
                            &nbsp;
                            <span
                                >Academic Requirements for Institute of Business
                                and Management (Victoria).</span
                            >
                            &nbsp;
                            <i class="fas fa-angle-down requirementAddon"></i>
                        </a>
                        ...
                        <div class="collapse show" id="clps11">
                            <div class="p-justify card card-body">
                                Students must have completed the Certificate III
                                in Commercial Cookery (or Equivalent) Students
                                will be evaluated on a case-by-case basis to
                                ensure that they meet entry requirements and
                                that they are enrolled in the units required to
                                meet the packaging rules for SIT40521
                        ...
                        <div class="collapse" id="clps2">
                            <div class="card card-body">
                                <ul class="list-items p-justify">
                                    <li>
                                        Have a minimum IELTS score of 5.5 for
                                        direct entry into a VET course OR.
                                    </li>
                                    <li>
                                        IELTS score of 5.0 or equivalent with an
                                        ELICOS course (up to 10 weeks) to be
                                        taken before the main VET course;or,
                                        IELTS score of 4.5 or equivalent with an
                                        ELICOS course (up to 20 weeks) to be
                                        taken before the main VET course OR.
                                    </li>
                                    <li>
                                        to provide evidence that they have
                                        studied in English for at least five
                                        years in Australia, Canada, New Zealand,
                                        Republic of Ireland, South Africa,
                                        United Kingdom or United State OR.
                                    </li>
                                    <li>
                                        to provide evidence that, within two
                                        years* of their signed written agreement
                                        date, they have successfully completed
                                        in Australia a Certificate IV or
                                        higher-level qualification, from the
                                    ...
                                    <li>
                                        ...
                                        qualification from an English language
                                        speaking country.
                                    </li>
                                    <li>
                                        Institute of Business and Management
                                        also has an English proficiency test to
                                        ensure that students have the English
                    ...
                    <div class="collapsible">
                        ...
                        >
                            ...
                            &nbsp;
                            <span
                                >Qualification Requirements for Institute of
                                Business and Management (Victoria)</span
                            >
                            &nbsp;
                            <i class="fas fa-angle-right requirementAddon"></i>
                        </a>
                        ...
                        <div class="collapse" id="clps18">
                            <div class="card card-body">
                                <ul class="p-justify">
                                    ...
                                    <li>
                                        Students will be evaluated on a
                                        case-by-case basis to ensure that they
                                        meet entry requirements and that they
                                        are enrolled in the units required to
                                        meet the packaging rules for SIT40521
                                ...
                                <ul class="list-items p-justify">
                                    ...
                                    <li>
                                        <b
                                            ...
                                            assessment test: </b
                                        >prior enrolment to determine the
                                    ...
                                    <li>
                                        <b>Kitchen toolkit: </b>
                                        students will need access to a kitchen
                                        toolkit which includes a chef’s uniform,
                                        safety shoes, various knives, and small
                                        equipment. This will be arranged and
                                        provided by Institute of Business and
                                        Management (Victoria).
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <b>Hardware/Software requirements: </b
                                        >Institute of Business and Management
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps5">
                            <div class="p-justify card card-body">
                                <p>
                                    On completion of SIT40521 Certificate IV in
                                    Kitchen Management, students may undertake
                                    one or more of following qualifications:
                                </p>
                                <ul class="list-items">
                                    <li>
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps6">
                            <div class="p-justify card card-body">
                                <p>
                                    Students completing SIT40521 Certificate IV
                                    in Kitchen Management can expect to gain
                                    work as a:
                                </p>
                                <ul class="list-items">
                                    <li>
                                        Commercial cook in organisations such as
                                        restaurants, hotels, clubs, pubs, cafés,
                                        and coffee shops.
                                    </li>
                                    <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps10">
                            <div class="card card-body">
                                <p>
                                    The duration of this qualification is 78
                                    weeks, including 18 weeks term break. The
                            ...
                            <table class="table table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>SITHCCC027*</td>
                                        <td>
                                            Prepare dishes using basic methods
                                            of cookery
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>SITHKOP012*</td>
                                        <td>
                                            Develop recipes for special dietary
                                            requirements
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>BSBSUS211</td>
                                        <td>
                                            PARTICIPATE IN SUSTAINBLE WORK
                                            PRACTICE
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="course-structure">
                        ...
                        <div class="collapsible">
                            ...
                            >
                                ...
                                &nbsp;
                                <i
                                    class="fas fa-angle-down show requirementAddon"
                                ></i>
                            </a>
            ...
            <div class="row my-1">
                <div class="col-md-12">
                    <div class="course-structure">
                        ...
                        <div class="my-3"></div>
                        <p class="p-justify">
                            This course includes work-based training of a
                            minimum of 200 hours/10 weeks. During work-based
                            training, students will be able to practice their
                            skills and knowledge in real workplace settings.
                            This will assist students to be job-ready at
                            graduation. Institute of Business and Management
                            (Victoria) will ensure placement of all students.
                            This is to ensure international students with
                            limited exposure to Australian workplace are not
                            disadvantaged. Students will have the option to
                            arrange their own work placement provided it meets
                            all requirements. The assessor will visit and assess
                            the student at least twice during this time at a
