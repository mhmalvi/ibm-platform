    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="my-3"></div>
          <p class="p-justify">
            This qualification would apply to international students who would
            be dreaming to become executive officers, program consultants and
            program coordinators. Individuals in these roles may possess
            substantial experience in a range of settings but seek to further
            develop their skills across a wide range of business functions.
            Conversely, it may also apply to those with little or no vocational
            experience.
          </p>
          <div class="my-3"></div>
          ...
          <div class="collapsible">
            ...
            <div class="collapse show" id="clps1">
              ...
              <p>International Students applying for this qualification must have a minimum English language proficiency
                of IELTS 6.0 or an equivalent exam result recognised by the Department of Home Affairs.</p>
              <p style="font-weight: bold;">You must still take the IBM (VIC)’s pre-entry placement test at Orientation.
              ...
              <ul class="pt-3 list-items">
                ...
                <li>you are an applicant who is a Foreign Affairs or, Defence sponsored student or a Secondary Exchange
                  student (AASES) </li>
                <li>you are enrolled in a principal course of study that is a registered school course, a standalone
                  English Language Intensive Course for Overseas Students (ELICOS), a course registered to be delivered
                  in a language other than English, or a registered post-graduate research course </li>
                ...
                <li>in the 2 years before applying for the student visa, you completed, in Australia and in the English
                  language, either the Senior Secondary Certificate of Education or a substantial component of a course
                  leading to a qualification from the Australian Qualifications Framework at the Certificate IV or
                  higher level, while you held a student visa. </li>
              </ul>
            </div>
          </div>
          <!-- <div class="collapse show" id="clps1"> -->
        ...
        <div class="collapsible">
          <a @click="changeAngle($event)" data-position="right" class="w-100" data-bs-toggle="collapse" href="#clps3"
            role="button" aria-expanded="false" aria-controls="clps3">
            <i class="fas fa-file-certificate"></i>
            &nbsp;
            <span>LLN</span>
            &nbsp;
          ...
          <div class="collapse" id="clps3">
            <div class="p-justify card card-body">
              ...
              occur prior to the course commencement and will be assessed by
              authorised IBM (Victoria) delegate.
            </div>
          </div>
        </div>
        <div class="collapsible">
          <a @click="changeAngle($event)" data-position="right" class="w-100" data-bs-toggle="collapse" href="#clps4"
            role="button" aria-expanded="false" aria-controls="clps4">
            <i class="fas fa-file-certificate"></i>
            &nbsp;
        ...
        <div class="collapsible">
          ...
          <div class="collapse show" id="clps6">
            <div class="p-justify card card-body">
              ...
              <ul class="pt-3 list-items">
                <li>
                  Accounts Supervisor Frontline Manager Office Manager Team
                  Leader.
                </li>
          ...
          <div class="collapse show" id="clps7">
            <div class="p-justify card card-body">
              ...
              <ul class="pt-3 list-items">
                ...
                <li>Sales Manager.</li>
                <li>Business Professional development programs.</li>
              </ul>
          ...
          <div class="text-center pt-5">
            <table class="table table-striped table-hover">
              <tbody>
                ...
                <tr>
                  <td>BSBLDR523</td>
                  <td>Lead and manage effective workplace relationship</td>
                  <td>Elective</td>
                </tr>
                <tr>
                  <td>BSBLDR522</td>
                ...
                <tr>
                  <td>BSBPEF501</td>
                  <td>Manage personal and professional development</td>
                  <td>Elective</td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="course-structure">
                    ...
                    <tr>
                      <td colspan="3">
                        <p class="p-justify py-2">
                          ...
                          consisting of 50 weeks of face-to-face study over 5
                          terms (10 weeks) and 4 weeks of term break.
                        </p>
                      </td>
                    </tr>
                  </tbody>
          ...
          <div class="collapsible">
            <a @click="changeAngle($event)" data-position="right" class="w-100" data-bs-toggle="collapse"
              href="#handbook" role="button" aria-expanded="fasle" aria-controls="handbook">
              <i class="fas fa-file-certificate"></i>
              &nbsp;
            ...
            <div class="collapse" id="clps8">
              <div class="card card-body">
                ...
                <p class="pt-3 p-justify">
                  ...
                  language, literacy and numeracy (LLN) assessment they may
                  undertake to confirm their level of language, literacy and
                  numeracy skills. Reasonable adjustments to training and
                  assessment will be made and additional support (e.g. LLN,
                  assistive technology, additional training, alternative
                  delivery and assessment modes and methods) provided where
                  students with physical attributes or specific learning needs
                  are identified as requiring these changes to complete their
