        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="my-3"></div>
                    <p class="p-justify">
                        This qualification would apply to international students
                        who would be dreaming to become executive officers,
                        program consultants and program coordinators.
                        Individuals in these roles may possess substantial
                        experience in a range of settings but seek to further
                        develop their skills across a wide range of business
                        functions. Conversely, it may also apply to those with
                        little or no vocational experience.
                    </p>
                    <div class="my-3"></div>
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps1">
                            <div class="p-justify card card-body">
                                ILETS 5.5 (Academic or general) or equivalent
                                internationally recongnised test result in line
                                with DIBP regulation. or Completed secondary
                                studies equivalent to an Australian Year 12
                                qualification form Level 1 countries as
                                identified by DIBP.
                            </div>
                        </div>
                    </div>
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps2">
                            ...
                            >
                                ...
                                satisfactorily completed a minimum of year 11 or
                                equivalent.
                            </div>
                        </div>
                    </div>
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps3">
                            <div class="p-justify card card-body">
                                ...
                                Literacy and Numeracy (LLN) Evaluation test to
                                all students to ensure that they have the
                                ability to complete the course. This test will
                                occur prior to the course commencement and will
                                be assessed by authorised IBM (Victoria)
                                delegate.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps5">
                            <div class="p-justify card card-body">
                                On completion of this qualification, students
                                may undertake qualifications at Advanced Diploma
                                level or above in Business training package.
                            </div>
                        </div>
                    </div>
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps6">
                            <div class="p-justify card card-body">
                                <p>
                                    Participants completing BSB50120 Diploma of
                                    Business may enter or continue current roles
                                    including:
                                </p>

                                <ul class="pt-3 list-items">
                                    <li>
                                        Accounts Supervisor Frontline Manager
                                        Office Manager Team Leader.
                                    </li>
                                    <li>Accounts Supervisor.</li>
                                    <li>Frontline Manager.</li>
                                    <li>Office.</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps7">
                            <div class="p-justify card card-body">
                                ...
                                <ul class="pt-3 list-items">
                                    <li>Executive Work experience.</li>

                                    <li>Area Manager Life experience.</li>
                                    <li>Business Previous study.</li>
                                    <li>Sales Manager.</li>
                                    <li>
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps10">
                            <div class="p-justify card card-body">
                                <p>
                                    This course will be delivered over 54 weeks
                                    consisting 50 weeks of 5 terms (10 weeks
                                    each) and 4 weeks term break
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="collapse" id="clps11">
                            <div class="p-justify card card-body">
                                <p style="text-align: justify" class="pb-2">
                                    ...
                                    form and PTR form allows the applicant to
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="my-3"></div>
                        <p class="p-justify">
                            The BSB50120 Diploma of Business requires the
                            successful completion of twelve (12) units (5 Core +
                            7 Elective). Electives for this qualification have
                            been chosen by Institute of Business and Management
                        ...
                        <div class="text-center pt-5">
                            <table class="table table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>BSBTWK503</td>
                                        <td>Manage meetings</td>
                                        <td>Elective</td>
                                    </tr>
                                    <tr>
                                        <td>BSBTWK501</td>
                                        <td>Lead diversity and inclusion</td>
                                        <td>Elective</td>
                                    </tr>
                                    <tr>
                                        <td>BSBOPS504</td>
                        ...
                        <div class="collapsible">
                            ...
                            <div class="collapse show" id="fees">
                                <div class="card card-body">
                                    <table
                                        class="table table-responsive p-justify"
                                    >
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <p class="p-justify py-2">
                                                        This course will be
                                                        delivered over 54 weeks
                                                        consisting of 50 weeks
                                                        of face-to-face study
                                                        over 5 terms (10 weeks)
                                                        and 4 weeks of term
                                                        break.
                                                    </p>
                                                </td>
                            ...
                            <div class="collapse" id="clps8">
                                <div class="card card-body">
                                    ...
                                    <p class="pt-3 p-justify">
                                        Where language, literacy and numeracy
                                        are in question Institute of Business
                                        and Management (Victoria) has a
                                        language, literacy and numeracy (LLN)
                                        assessment they may undertake to confirm
                                        their level of language, literacy and
                                        numeracy skills. Reasonable adjustments
                                        to training and assessment will be made
                                        and additional support (e.g. LLN,
                                        assistive technology, additional
                                        training, alternative delivery and
                                        assessment modes and methods) provided
                                        where students with physical attributes
                                        or specific learning needs are
                                        identified as requiring these changes to
                                        complete their training and assessment.
                                    </p>
                                </div>
                            </div>
                        </div>
