            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="p-justify">
                        ...
                        variety of Business Services job roles. These
                        individuals may have general management
                        accountabilities. Individuals in these roles carry out
                        complex tasks in a specialist field of expertise. They
                        may undertake technical research and analysis and will
                        often contribute to setting the strategic direction for
                        a work area.
                    </p>
                    <div class="my-3"></div>
                    <table class="table table-responsive">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    Building D, 60 Belfast Street, Broadmeadows,
                                    VIC, 3047.
                                </td>
                            </tr>
                            <tr>
                    ...
                    <p>
                        All international students must be 18 years of age at
                        ...
                        <div class="collapse" id="clps2">
                            <div class="card card-body">
                                ...
                                <p class="p-justify">
                                    ...
                                    OR Have 2 years equivalent full time
                                    relevant workplace experience in an
                                    operational or leadership role in an
                                    enterprise.
                                </p>

                                <!-- <p class="p-justify"><i class="fas fa-arrow-right theme-color" aria-hidden="true"></i> 
                English language: An IELTS level of 5.5 or equivalent for direct entry
                into a VET course or IELTS band score of 5.0 (Academic or general
                version) then satisfactory completion of ELICOS up to 20 weeks at
                upper intermediate level to be taken before the main VET course.
                (Results older than two years are not acceptable)
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps3">
                            <div class="p-justify card card-body">
                                IBM (Victoria) will also administer Language,
                                Literacy and Numeracy (LLN) Evaluation test and
                                PTR Test to all students to ensure that they can
                                complete the course and if they any specific
                                student needs. These tests will occur prior to
                                the course commencement and will be assessed by
                                authorised IBM (Victoria) delegate.
                            </div>
                        </div>
                    </div>
                    <div class="collapsible">
                        ...
                        <div class="collapse" id="clps4">
                            <div class="p-justify card card-body">
                                All international students must have Overseas
                                Student Health Cover (OSHC) for the entire
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps5">
                            <div class="p-justify card card-body">
                                On completion of BSB60120 Advanced Diploma of
                                Business, students may undertake qualifications
                                at Advanced Diploma or above in business
                                training package or pursuing Bachelors in
                                Business.
                            </div>
                        </div>
                    </div>
                    <div class="collapsible">
                        ...
                        <div class="collapse show" id="clps6">
                            <div class="p-justify card card-body">
                                <p>
                                    Participants completing BSB60120 Advanced
                                    Diploma of Business may enter into or
                                    continue current roles including:
                                </p>

                                <ul class="pt-3 list-items">
                                    <li>Entrepreneurship.</li>
                                    <li>Business Enterprise Manager.</li>
                        ...
                        <div class="collapse" id="clps10">
                            <div class="p-justify card card-body">
                                <p>
                                    ...
                                    consisting of 60 weeks of face-to-face study
                                    over 5 terms (12 weeks each) and 4 weeks of
                                    term break.
                                </p>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>
                            The BSB60120 Advanced Diploma of Business requires
                            the successful completion of 9 units listed out of
                            ten. Electives for this qualification have been
                            chosen by Institute of Business and Management
                            (Victoria) to ensure that students achieve a broad
                            range of skills and knowledge in business.
                        </p>
                        <div class="my-3"></div>
                        <div class="text-center pt-5">
                            <table class="table table-striped table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>BSBFIN601</td>
                                        <td>Manage organisational finances</td>
                                        <td>Core</td>
                                    </tr>
                                    <tr>
                                        <td>BSBOPS601</td>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <p class="p-justify py-1">
                                                        ...
                                                        their current
                                                        qualification will not
                                                        incur any fee increases.
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <p class="p-justify py-1">
                                                        This course will be
                                                        delivered over 64 weeks
                                                        consisting of 60 weeks
                                                        of face-to-face study
                                                        over 5 terms (12 weeks
                                                        each) and 4 weeks of
                                                        term break.
                                                    </p>
                                                </td>
                            ...
                            <div class="collapsible">
                                ...
                                <div class="collapse" id="handbook">
                                    <div class="p-justify card card-body">
                                        ...
                                        Information about our training and
                                        assessment, policies and procedures are
                                        included in student handbook and should
                                        be read by you, prior to enrolment,
                                        which is available on institute’s
                                        website. These documents contain
                                        important information about your
                                        training course, fees and charges
                                        including our refund policy.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="collapsible">
                                ...
                                <div class="collapse" id="stdSupport">
                                    <p class="p-justify card card-body">
                                        Student needs are declared by the
                                        applicant at the time of enrolment: the
                                        application form allows the applicant to
                                        self-declare where they have learning
                                        disabilities. Every student is
                                        interviewed either face-to-face or over
                                        the telephone to attempt to establish
                                        the applicant skill and knowledge
                                        levels, their current employment and how
                                        that relates to the course content and
                                        interaction. Where language, literacy
                                        and numeracy are in question Institute
                                        of Business and Management (Victoria)
                                        has a language, literacy and numeracy
                                        (LLN) assessment they may undertake to
                                        confirm their level of language,
                                        literacy and numeracy skills. Reasonable
                                        adjustments to training and assessment
                                        will be made and additional support
                                        (e.g. LLN, assistive technology,
                                        additional training, alternative
                                        delivery and assessment modes and
                                        methods) provided where students with
                                        physical attributes or specific learning
                                        needs are identified as requiring these
                                        changes to complete their training and
                                        assessment.
                                    </p>
                                </div>
                            </div>
