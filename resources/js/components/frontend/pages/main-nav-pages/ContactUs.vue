<template>
    <base-layout>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="contact-img mb-30">
                            <img
                                ...
                                :src="
                                    image_url +
                                    '/frontend/assets/img/contact/01.png'
                                "
                                alt=""
                            />
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="contact-wrapper pl-75 mb-30">
                            <div class="section-title mb-30">
                                ...
                                <p>
                                    If you have any questions and queries just
                            ...
                            <div class="single-contact-box cb-2 mb-30">
                                <div class="contact__iocn">
                                    <img
                                        :src="
                                            image_url +
                                            '/frontend/assets/img/icon/phone-alt.svg'
                                        "
                                        alt=""
                                    />
                                </div>
                            ...
                            <div class="single-contact-box cb-3 mb-30">
                                <div class="contact__iocn">
                                    <img
                                        :src="
                                            image_url +
                                            '/frontend/assets/img/icon/feather-mail.svg'
                                        "
                                        alt=""
                                    />
                                </div>
        ...
        <section
            class="contact-form-area pt-50 pb-50 pt-md-100 pt-xs-100 pb-md-70 pb-xs-70"
        >
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="contact-form-wrapper mb-30">
                            ...
                            >
                                ...
                                <div class="col-lg-12 mb-30">
                                    <button
                                        type="submit"
                                        class="theme_btn message_btn mt-20"
                                    >
                                        Send Message
                                    </button>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-img contact-img-02 mb-30">
                            <img
                                ...
                                :src="
                                    image_url +
                                    '/frontend/assets/img/contact/02.jpg'
                                "
                                alt=""
                            />
                        </div>
                ...
                .catch((error) => {
                    ...
                    if (error.response.status == 404) {
                        ...
                        $.each(
                            ...
                            function (item, index) {
                                let input = jQuery(document).find(
                                    'input[name="' + item + '"]'
                                );
