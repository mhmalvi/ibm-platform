                    ...
                    <div class="col-lg-8">
                        <div class="blog-details-box mb-45">
                            ...
                            <ul class="blogs__meta mb-30">
                               <li><span class="blog-author">By {{post.user_name}}</span></li>
                               <li><span><img :src="image_url+'/frontend/assets/img/icon/material-date-range.svg'" alt="mate-date"> {{post.created_at}}</span></li>
                            ...
                            <img class="img-fluid blog-details-img mb-35" :src="image_url+'/uploads/post/'+post.feature_image" alt="blog-details-img">
    ...
    export default {
        ...
        methods: {
            getSingleBlogs() {
                ...
                axios.get(this.base_url + '/api/get-single-blog-post/' + slug)
                    .then(res => {
