...
export default {
    ...
    methods:{
        ...
        processData(){
            ...
            let getdata = this.isFile== true || this.isForm?formData:this.inputData
        ...
        getDataList(page = 1, sorting_item){
            ...
            // console.log('sorting_item', sorting_item);
            ...
            let api_path = this.url+'/api/'+api+'?page='+page+'&search='+search+'&sorting='+query+'&data='+formData
            ...
            .then(response => {
                ...
                if(response.status == 200){
                    ...
                    if(query === 'all_data'){
                        ...
                        this.dataDownload = response.data.data
                        this.isLoading = true 
