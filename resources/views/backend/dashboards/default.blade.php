...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
    ...
    <div class="col-xl-4 xl-50 col-md-6">
      <div class="card user-card">
        <div class="card-body">
          ...
          <div class="user-card-image"><img class="img-fluid rounded-circle image-radius" src="{{asset('assets/images/dashboard/designer.jpg')}}" alt=""></div>
    ...
    <div class="col-xl-6">
      <div class="card height-equal">
        ...
        <div class="card-body">
          <div class="new-users">
            <div class="media"><img class="rounded-circle image-radius m-r-15" src="{{asset('assets/images/user/2.png')}}" alt="">
              <div class="media-body">
            ...
            <div class="media"><img class="rounded-circle image-radius m-r-15" src="{{asset('assets/images/user/5.jpg')}}" alt="">
              <div class="media-body">
            ...
            <div class="media"><img class="rounded-circle image-radius m-r-15" src="{{asset('assets/images/user/3.jpg')}}" alt="">
              <div class="media-body">
            ...
            <div class="media"><img class="rounded-circle image-radius m-r-15" src="{{asset('assets/images/user/4.jpg')}}" alt="">
              <div class="media-body">
    ...
    <div class="col-xl-7 xl-100">
      <div class="card">
        ...
        <div class="card-body chat-box dashboard-chat">
          <div class="chat">
            <div class="media left-side-chat"><img class="rounded-circle chat-user-img img-60 m-r-20" src="{{asset('assets/images/user/4.jpg')}}" alt="">
              <div class="media-body">
            ...
            <div class="media right-side-chat">
              ...
              </div><img class="rounded-circle chat-user-img img-60 m-l-20" src="{{asset('assets/images/user/5.jpg')}}" alt="">
            </div>
            <div class="media left-side-chat"><img class="rounded-circle chat-user-img img-60 m-r-20" src="{{asset('assets/images/user/4.jpg')}}" alt="">
              <div class="media-body">
                <div class="message-main">
                ...
                <div class="sub-message message-main smiley-bg"><img src="{{asset('assets/images/dashboard/smily.png')}}" alt=""></div>
              </div>
            </div>
          </div>
        </div>
